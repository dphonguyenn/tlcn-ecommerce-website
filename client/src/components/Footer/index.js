      ...
      <Container maxWidth="lg">
        <Paper sx={styles.paper}>
          <div style={styles.main_footer}>
            <Typography sx={styles.text_header_footer}>
              Tự tin mua sắm cùng LapDarker
            </Typography>
            {/*  */}
            <div
              style={Object.assign(
            ...
            >
              ...
              >
                ...
                <Typography sx={styles.text_body02}>
                  Tất cả các sản phẩm do LapDarker bán ra đều được tuân thủ điều
                  kiện bảo hành của nhà cung cấp, hãng sản xuất. Nếu có vấn đề
                  về chất lượng sản phẩm, LapDarker xin cam kết sẽ hỗ trợ Quý
                  khách tới cùng.
                </Typography>
              ...
              >
                ...
                <Typography sx={styles.text_body02}>
                  ...
                  trợ đổi trả 1-1 hoặc hoàn tiền 100% nếu phát sinh lỗi hoặc cảm
                  thấy sản phẩm chưa đáp ứng được nhu cầu.
                </Typography>
                <div style={styles.btn_info}>
                  <Typography sx={styles.text_btn_info}>Chi tiết</Typography>
                  <AiOutlineArrowRight style={styles.icon_btn_info} />
            ...
            >
              <FiInfo
                style={Object.assign({ margin: "12px 0 0 0" }, styles.icons)}
              />
              ...
              <Grid container rowSpacing={1} columnSpacing={2}>
                <Grid item md={6}>
                  <Button sx={styles.btn_contact}>
                    ...
                    <Typography sx={styles.text_btn_ct}>
                      Hotline: 0947443064
                    </Typography>
                  </Button>
                </Grid>
            ...
            >
              ...
              />
              <Typography sx={styles.text_body01}>
                LapDarker trên social networks
              </Typography>
              <div style={styles.group_btn_social}>
                <Button
                  sx={Object.assign({ ml: "0 !important" }, styles.btn_social)}
                >
        ...
        <Paper sx={Object.assign(styles.paper)}>
          ...
          >
            ...
            >
              ...
              <Typography sx={styles.text_body03}>
                Chân thành phục vụ từ 2022
              </Typography>
              <Grid container rowSpacing={1} columnSpacing={2}>
                <Grid item md={4}>
                  <Button sx={styles.btn_redirect}>
                    <Typography sx={styles.text_btn_redirect}>
                      Về chúng tôi
                    </Typography>
                  </Button>
                </Grid>
