      ...
      <div tabIndex={0} style={styles.wrap_panel}>
        <RadioGroup value={valueRadio}>
                ...
                <div style={styles.aside_content}>
                  ...
                  <div style={styles.box_info1}>
                    <Typography sx={styles.text6}>
                      <strong>Nội dung chuyển khoản</strong> 'Tên khách hàng, số
                      điện thoại'
                    </Typography>
                    <Typography sx={styles.text6}>
                  ...
                  <div style={styles.box_info2}>
                    <Typography sx={styles.text6}>
                      Bạn hãy chọn <strong>Dịch vụ chuyển tiền 24/7</strong> để
          ...
          <Box sx={styles.box} onClick={() => handleCheckedRadio("Thẻ ATM")}>
            ...
            <div style={styles.aside_box}>
              <Typography
                sx={Object.assign({ ...styles.text4 }, { pb: "4px" })}
              >
                Thẻ ATM
              </Typography>
              <Typography sx={styles.text9}>
        ...
        <Container maxWidth="lg" sx={{ p: "16px 0" }}>
          ...
          <Grid columnSpacing={4} container>
            <Grid item md={8}>
              <Alert
                icon={
                  <img src={check} alt="success icon" style={styles.img1} />
                }
                severity="success"
                sx={styles.alert}
              >
                ...
                <Typography sx={styles.text5}>
                  Chuyên viên bán hàng sẽ gọi điện xác nhận trong{" "}
                  <strong>10 phút</strong> tới
                </Typography>
              </Alert>
            ...
            <Grid item md={4}>
              <div style={styles.wrap_aside}>
                  ...
                  <div>
                    ...
                    <div style={styles.part7}>
                      <div style={style.part7_1}>
                        ...
                        <Typography
                          sx={Object.assign({ ...styles.text12 }, { p: "0px" })}
                        >
                          Phí vận chuyển dự kiến
                        </Typography>
                        <Typography sx={styles.text15}>
                          Miễn phí khi thanh toán trước
                        </Typography>
                      </div>
                ...
                >
                  Đơn hàng đã đủ điều kiện <strong>miễn phí vận chuyển</strong>{" "}
