...
function OrderItem({ data }) {
  ...
  switch (data.state) {
    case "WAIT_FOR_PAY":
      Payment = () => (
        <Typography
          sx={Object.assign({ ...styles.text13 }, { textTransform: "initial" })}
        >
          Chưa thanh toán
        </Typography>
      );
  ...
  const _address =
    ...
    data.address ===
      "Số 112 Đ. Chu Văn An, phường Nghĩa Lộ, Thành phố Quảng Ngãi" ||
    data.address ===
            ...
            <div style={styles.wrap_part3}>
              ...
              <div style={styles.part3_main}>
                ...
                <div style={styles.part3_2}>
                  ...
                  {prd.sale !== 0 && (
                    <Typography sx={styles.text7}> -{prd.sale}%</Typography>
                  )}
                </div>
                <div style={styles.part3_3}>
                  ...
                  >
                    ...
                    >
                      <Typography
                        component="span"
                        sx={{ fontSize: "13px", fontWeight: "bold", pr: "4px" }}
                      >
                        {data.totalItems}
                      </Typography>
                  ...
                  <Grid container sx={{ p: "0 0 0 8px" }}>
                    <Grid item md={3}>
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <Typography
                          sx={Object.assign({ ...styles.text6 }, { p: 0 })}
                        >
                  ...
                  <div style={styles.part5}>
                    <div style={styles.wrap_part5}>
                      <div style={{ display: "flex", alignItems: "center" }}>
                        ...
                        />
                        <Typography
                          sx={Object.assign({ ...styles.text15 }, { p: 0 })}
                        >
                          Nhận tại {_address}
                        </Typography>
                      </div>
                ...
                <div style={styles.container}>
                      ...
                      >
                        <div style={styles.wrap_part3}>
                          ...
                          <div style={styles.part3_main}>
                            <div style={{ display: "flex" }}>
                              <Link
                                to={`/product/${product.type}s/${product.id}`}
                                style={{ textDecoration: "none" }}
                              >
                  ...
                  <div style={styles.container}>
                    ...
                    <RadioGroup value={valueRadio}>
                      <Box
                        sx={styles.box_payment}
                        onClick={() => handleCheckedRadio("Chuyển khoản")}
                      >
                        <FormControlLabel
                          value="Chuyển khoản"
                          control={<Radio />}
                        ...
                        <div style={styles.aside_box_payment}>
                          ...
                          {showInfoBanking && (
                            <div style={styles.aside_content}>
                              ...
                              <Typography sx={styles.text17}>
                                Vietcombank - Ngân Hàng Ngoại Thương Việt Nam
                              </Typography>
                              <Typography sx={styles.text19}>
                                Chủ tài khoản:{" "}
                                <strong>NGUYEN BUI DUY PHONG</strong>
                              </Typography>
                              <Typography sx={styles.text19}>
                              ...
                              <div style={styles.box_info1}>
                                <Typography sx={styles.text18}>
                                  <strong>Nội dung chuyển khoản</strong> 'Tên
                                  khách hàng, số điện thoại'
                                </Typography>
                                <Typography sx={styles.text18}>
                                  <strong>Ví dụ</strong> 'Nguyen Van A,
                                  0912345678'
                                </Typography>
                              </div>
                              <div style={styles.box_info2}>
                                <Typography sx={styles.text18}>
                                  Bạn hãy chọn{" "}
                                  <strong>Dịch vụ chuyển tiền 24/7</strong> để
                      ...
                      <Box
                        sx={styles.box_payment}
                        onClick={() => handleCheckedRadio("Thẻ ATM")}
                      >
                      ...
                      <Box
                        sx={styles.box_payment}
                        onClick={() => handleCheckedRadio("VN Pay")}
                      >
                        <FormControlLabel value="VN Pay" control={<Radio />} />
                        <div
                          style={Object.assign(
                            { ...styles.aside_box_payment },
                            { display: "flex" }
                          )}
                        >
                          <Typography sx={styles.text16}>
                      ...
                      <Box
                        sx={styles.box_payment}
                        onClick={() => handleCheckedRadio("MOMO")}
                      >
                      ...
                      <Box
                        sx={styles.box_payment}
                        onClick={() => handleCheckedRadio("Thẻ Quốc Tế")}
                      >
                        <FormControlLabel
                          value="Thẻ Quốc Tế"
                          control={<Radio />}
                        ...
                        <div style={styles.aside_box_payment_payment}>
                          ...
                          <Typography sx={styles.text21}>
                            Hỗ trợ Visa, Master, JCB
                          </Typography>
                          <img
                            src={creadit}
                            alt="credits"
          ...
          <div style={{ backgroundColor: "#fff" }}>
            <div style={{ padding: "12px 24px", display: "flex" }}>
              ...
              <Button
                ...
                sx={Object.assign({ ...styles.btn2 }, { flex: 1 })}
              >
