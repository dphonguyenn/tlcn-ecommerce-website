            ...
            <div style={styles.wrap_part3}>
              ...
              <div style={styles.part3_main}>
                ...
                <div style={styles.part3_3}>
                  ...
                  <div style={{ borderRadius: '4px', backgroundColor: 'rgba(236, 240, 241,1)' }}>
                  ...
                  <Grid container sx={{ p: '0 0 0 8px' }}>
                    ...
                    <Grid item md={3} sx={{ alignSelf: 'end' }}>
                      <div style={{ display: 'flex', justifyContent: 'end' }}>
                        <div style={{ backgroundColor: 'rgba(248, 250, 252, 1)', borderRadius: '8px' }}>
                            ...
                            <div style={styles.part3_3}>
                              ...
                              <div style={{ borderRadius: '4px', backgroundColor: 'rgba(236, 240, 241,1)' }}>
                                <div style={{ padding: '4px', display: 'flex', alignItems: 'center' }}>
                                  ...
                                  <Typography component="span" sx={{ fontSize: '13px', fontWeight: 'bold', pl: '4px' }}>
                                    {product.quantity}
                                  </Typography>
                                </div>
                              </div>
